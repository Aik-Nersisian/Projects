<template>
  <div class="notifications-icon">
    ...
    >
      ...
      />
      <path
        d="M17.8378 3.48649C16.0914 3.48649 14.6757 4.90223 14.6757 6.64865C14.6757 8.39506 16.0914 9.81081 17.8378 9.81081C19.5843 9.81081 21 8.39506 21 6.64865C21 4.90223 19.5843 3.48649 17.8378 3.48649Z"
      />
    </svg>
    <p class="notifications-number">{{ count }}</p>
  </div>
</template>
